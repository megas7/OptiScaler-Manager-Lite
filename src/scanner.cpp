...
void AddSteamLibrariesFrom(std::vector<std::wstring>& roots,
...
constexpr const wchar_t* kPrefixes[] = {
    L"unins",        L"uninstall",   L"setup",        L"dxsetup",   L"dxwebsetup",
    L"vc_redist",    L"vcredist",    L"vc_runtime",   L"helper",    L"crashreport",
    L"readme",       L"support",     L"patch",        L"update",    L"redistributable",
    L"installer",    L"install",     L"autorun",      L"bootstrap", L"ue4prereq",
    L"benchmark",    L"diagnostic",  L"repair"};
...
constexpr const wchar_t* kSubstrings[] = {L"crashhandler",       L"crashreporter",   L"unitycrash",
                                          L"eac_launcher",      L"unrealcefsubprocess",
                                          L"prereq",            L"redistributable", L"updater",
                                          L"patcher",           L"support",          L"config",
                                          L"options",           L"settings",         L"benchmark",
                                          L"diagnostic",        L"utility",          L"tool",
                                          L"reporter",          L"firstrun",         L"troubleshooter",
                                          L"crashreportclient"};
